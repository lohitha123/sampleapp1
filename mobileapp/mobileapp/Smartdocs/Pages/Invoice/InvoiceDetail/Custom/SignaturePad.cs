...
namespace Smartdocs
{
	...
	{
		public static readonly BindableProperty BackgroundColorProperty = BindableProperty.Create<SignaturePad, Color>(p => p.BackgroundColor, Color.White);
		...
		public static readonly BindableProperty StrokeColorProperty = BindableProperty.Create<SignaturePad, Color>(p => p.StrokeColor, Color.Black);

...
{
	public class CarouselLayoutO : ScrollView
	{
		private readonly StackLayout _stack;

		private int _selectedIndex;

		public CarouselLayoutO()
		{
		...
		public static readonly BindableProperty SelectedIndexProperty =
			BindableProperty.Create<CarouselLayoutO, int>(
				carousel => carousel.SelectedIndex,
				0,
				BindingMode.TwoWay,
				propertyChanged: (bindable, oldValue, newValue) =>
				{
					((CarouselLayoutO)bindable).UpdateSelectedItem();
				}
			);
		...
		public static readonly BindableProperty ItemsSourceProperty =
			BindableProperty.Create<CarouselLayoutO, IList>(
				view => view.ItemsSource,
				null,
				propertyChanging: (bindableObject, oldValue, newValue) =>
				{
					((CarouselLayoutO)bindableObject).ItemsSourceChanging();
				},
				propertyChanged: (bindableObject, oldValue, newValue) =>
				{
					((CarouselLayoutO)bindableObject).ItemsSourceChanged();
				}
			);
		...
		public static readonly BindableProperty SelectedItemProperty =
			BindableProperty.Create<CarouselLayoutO, object>(
				view => view.SelectedItem,
				null,
				BindingMode.TwoWay,
				propertyChanged: (bindable, oldValue, newValue) =>
				{
					((CarouselLayoutO)bindable).UpdateSelectedIndex();
				}
			);
